...
useEffect(() => {
  ...
  const fetchSubjects = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/grading/subjects/${selectedClass}`,
        {
            headers: {
                Authorization: `Bearer ${token}`
            }
...
useEffect(() => {
  ...
  const fetchClassPerformance = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/analytics/class-summary/${selectedClass}?academic_session_id=${selectedSession}`,
        {
            headers: {
                Authorization: `Bearer ${token}`
            }
      ...
      if (response.data.examPerformance && response.data.examPerformance.length > 0) {
...
useEffect(() => {
  ...
  const fetchSubjectPerformance = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/examgrading/subject-performance/${selectedClass}?examination_id=${selectedExam}`,
        {
            headers: {
                Authorization: `Bearer ${token}`
            }
...
useEffect(() => {
  ...
  const fetchSubjectAnalysis = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/analytics/subject-analysis/${selectedSubject}?class_id=${selectedClass}&academic_session_id=${selectedSession}`,
        {
            headers: {
                Authorization: `Bearer ${token}`
            }
...
const prepareGradeDistribution = () => {
  if (!classPerformance || !classPerformance.examPerformance || classPerformance.examPerformance.length === 0) {
    return [];
  }
  ...
  return [
    { name: "A (70-100%)", value: performance.a_grade_count || 0, color: GRADE_COLORS.A },
    { name: "B (60-69%)", value: performance.b_grade_count || 0, color: GRADE_COLORS.B },
    { name: "C (50-59%)", value: performance.c_grade_count || 0, color: GRADE_COLORS.C },
    { name: "D (40-49%)", value: performance.d_grade_count || 0, color: GRADE_COLORS.D },
    { name: "F (0-39%)", value: performance.fail_count || 0, color: GRADE_COLORS.F }
  ];
};
...
const prepareSubjectPerformanceData = () => {
  ...
  return subjectPerformance.map(subject => ({
    name: subject.subject_name.length > 15 ? subject.subject_name.substring(0, 15) + '...' : subject.subject_name,
...
const preparePassFailData = () => {
  ...
  const passed = (performance.a_grade_count || 0) + 
...
const prepareSubjectDistribution = () => {
  ...
  return subjectAnalysis.examPerformance
    .filter(item => item.gradeDistribution && item.gradeDistribution.length > 0)
    .map(item => {
  ...
  <div className="space-y-6">
    ...
    <div className="bg-white p-4 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Subject Analysis</label>
          <select
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="border rounded-lg overflow-hidden">
                ...
                {expandedSections.overview && (
                  <div className="p-4">
                    {classPerformance && classPerformance.examPerformance && classPerformance.examPerformance.length > 0 ? (
                      <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                          <div className="bg-blue-50 p-4 rounded-lg">
                            <div className="text-sm text-blue-600 mb-1">Class Average</div>
                            <div className="text-2xl font-bold">
                              {classPerformance.examPerformance[0].performance?.average_score?.toFixed(1) || 0}%
                            </div>
                          ...
                          <div className="bg-green-50 p-4 rounded-lg">
                            ...
                            <div className="text-2xl font-bold">
                              {classPerformance.examPerformance[0].performance?.highest_score?.toFixed(1) || 0}%
                            </div>
                          ...
                          <div className="bg-yellow-50 p-4 rounded-lg">
                            <div className="text-sm text-yellow-600 mb-1">Pass Rate</div>
                            <div className="text-2xl font-bold">
                              {classPerformance.examPerformance[0].performance && 
                              classPerformance.examPerformance[0].performance.total_students > 0 ? 
                                (((classPerformance.examPerformance[0].performance.a_grade_count || 0) + 
                                  (classPerformance.examPerformance[0].performance.b_grade_count || 0) + 
                                  (classPerformance.examPerformance[0].performance.c_grade_count || 0) + 
                                  (classPerformance.examPerformance[0].performance.d_grade_count || 0)) / 
                                  classPerformance.examPerformance[0].performance.total_students * 100).toFixed(1) : 0}%
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                          ...
                          <div>
                            <h4 className="text-md font-medium mb-2">Pass/Fail Distribution</h4>
                            <div className="h-80 border rounded-lg p-4">
                              <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                                  <Pie
                      ...
                      <div className="text-center p-4 text-gray-500">
                        No performance data available for the selected class and examination.
                      </div>
                    )}
                  </div>
                )}
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-3 border rounded-md shadow-sm">
          ...
          <p>Average: {typeof data.average === 'number' ? `${data.average.toFixed(1)}%` : `${data.average || 0}%`}</p>
          <p>Pass Rate: {typeof data.passRate === 'number' ? `${data.passRate.toFixed(1)}%` : `${data.passRate || 0}%`}</p>
          <p>Passed/Failed: {data.passed}/{data.failed}</p>
        </div>
      );
    }
    return null;
...
/>
  ...
  <tr key={index}>
    ...
    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
      {typeof subject?.pass_percentage === 'number' 
        ? `${subject.pass_percentage.toFixed(1)}%` 
        : subject?.pass_percentage || "N/A"}
    </td>
    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
      {subject?.passed_count !== undefined && subject?.failed_count !== undefined
        ...
        : "N/A"}
                      ...
                      <div className="text-center p-4 text-gray-500">
                        No subject performance data available for the selected examination.
                      </div>
                    )}
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div>
                        <h3 className="text-lg font-medium text-gray-900">{subjectAnalysis.subject?.name || "Subject Analysis"}</h3>
                        <p className="text-sm text-gray-500">
                          Teacher: {subjectAnalysis.subject?.teacher_name || "Not Assigned"}
                        </p>
                      </div>
    ...
    <div className="text-2xl font-bold">
      {subjectAnalysis.examPerformance && 
       ...
       subjectAnalysis.examPerformance[0].performance ? 
        (typeof subjectAnalysis.examPerformance[0].performance.average_score === 'number' ?
          `${subjectAnalysis.examPerformance[0].performance.average_score.toFixed(1)}` : 
          subjectAnalysis.examPerformance[0].performance.average_score || 0
        ) : 0}%
    </div>
    <div className="text-sm text-blue-600">
  ...
  <div className="bg-green-50 p-4 rounded-lg">
    <div className="text-sm text-green-600 mb-1">Pass Rate</div>
    <div className="text-2xl font-bold">
      {subjectAnalysis.examPerformance && 
       subjectAnalysis.examPerformance.length > 0 && 
       subjectAnalysis.examPerformance[0].performance ? 
        (typeof subjectAnalysis.examPerformance[0].performance.pass_percentage === 'number' ?
          `${subjectAnalysis.examPerformance[0].performance.pass_percentage.toFixed(1)}` : 
          subjectAnalysis.examPerformance[0].performance.pass_percentage || 0
        ) : 0}%
    </div>
    <div className="text-sm text-green-600">
      students passed
  ...
  <div className="bg-purple-50 p-4 rounded-lg">
    <div className="text-sm text-purple-600 mb-1">Compared to Class</div>
    <div className="text-2xl font-bold">
      {subjectAnalysis.examPerformance && 
       subjectAnalysis.examPerformance.length > 0 && 
       subjectAnalysis.examPerformance[0].performance && 
       ...
       classPerformance.examPerformance[0].performance ? 
        (typeof subjectAnalysis.examPerformance[0].performance.average_score === 'number' &&
         typeof classPerformance.examPerformance[0].performance.average_score === 'number' ?
          `${(subjectAnalysis.examPerformance[0].performance.average_score - 
             classPerformance.examPerformance[0].performance.average_score).toFixed(1)}` : 0
        ) : 0}%
    </div>
    <div className="text-sm text-purple-600">
      from class average
                      ...
                      <div className="h-80 border rounded-lg p-4 mb-6">
                        <h4 className="text-md font-medium mb-2">Grade Distribution by Exam</h4>
                        <ResponsiveContainer width="100%" height="90%">
                          ...
                          >
                            ...
                            <Tooltip />
                            <Legend />
                            <Bar dataKey="A" name="A (70-100%)" stackId="a" fill={GRADE_COLORS.A} />
                            <Bar dataKey="B" name="B (60-69%)" stackId="a" fill={GRADE_COLORS.B} />
                            <Bar dataKey="C" name="C (50-59%)" stackId="a" fill={GRADE_COLORS.C} />
                            <Bar dataKey="D" name="D (40-49%)" stackId="a" fill={GRADE_COLORS.D} />
                            <Bar dataKey="F" name="F (0-39%)" stackId="a" fill={GRADE_COLORS.F} />
                          </BarChart>
                        </ResponsiveContainer>
                      </div>
                      ...
                      <div className="h-80 border rounded-lg p-4">
                        <h4 className="text-md font-medium mb-2">Performance Trend Over Time</h4>
                        <ResponsiveContainer width="100%" height="90%">
                          <LineChart
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      {subjectAnalysis.examPerformance && 
                       ...
                       subjectAnalysis.examPerformance[0].topStudents.length > 0 ? (
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                              <tr>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {subjectAnalysis.examPerformance[0].topStudents.map((student, index) => (
                                <tr key={index}>
                                  <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                                    {index + 1}
                                  </td>
                  ...
                  <div className="p-4">
                    {trendData && trendData.length > 0 ? (
                      <div>
                        ...
                        <div className="h-80 border rounded-lg p-4 mb-6">
                          <h4 className="text-md font-medium mb-2">Class Average Over Time</h4>
                          <ResponsiveContainer width="100%" height="90%">
                            <LineChart
                              data={trendData}
                              margin={{
                        ...
                        {subjectPerformance && subjectPerformance.length > 0 && (
                          <div className="h-80 border rounded-lg p-4 mb-6">
                            <h4 className="text-md font-medium mb-2">Subject Performance Comparison</h4>
                            <ResponsiveContainer width="100%" height="90%">
                              <AreaChart
                                data={trendData}
                                margin={{
                          ...
                          <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {trendData.map((exam, index) => {
                                ...
                                const previousAvg = index < trendData.length - 1 ? trendData[index + 1].class_average : null;
                                const change = previousAvg !== null ? (exam.class_average - previousAvg) : null;
                                const changeText = change !== null ? (change > 0 ? `+${change.toFixed(1)}%` : `${change.toFixed(1)}%`) : "-";
                                const changeClass = change !== null ? (change > 0 ? "text-green-600" : change < 0 ? "text-red-600" : "text-gray-500") : "";
                                ...
                                return (
                                  <tr key={index}>
                                    ...
                                    <td className={`px-4 py-3 whitespace-nowrap text-sm ${changeClass}`}>
                                      {changeText}
                                    </td>
                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                      {formattedDate}
                    ...
                    {trendData && trendData.length > 0 ? (
                      <div>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                          ...
                          <div className="h-80 border rounded-lg p-4">
                            <h4 className="text-md font-medium mb-2">Term-by-Term Comparison</h4>
                            <ResponsiveContainer width="100%" height="90%">
                              <BarChart
                                layout="vertical"
                                data={[
                          ...
                          <div className="h-80 border rounded-lg p-4">
                            <h4 className="text-md font-medium mb-2">Year-to-Year Comparison</h4>
                            <ResponsiveContainer width="100%" height="90%">
                              <LineChart
                                data={[
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg text-blue-800 text-sm">
                          <p className="flex items-center">
                            ...
                            <span>The comparative data shown here is sample data. In a production environment, this would be populated with actual historical data from your database.</span>
                          </p>
                        </div>
                      </div>
                    ) : (
                    ...
                    {topStudents && topStudents.length > 0 ? (
                      <div>
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                          <h4 className="text-md font-medium">Top Performing Students for {getExamName(selectedExam)}</h4>
                          <div className="mt-2 md:mt-0">
                            <select
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-center p-4 text-gray-500">
                      ...
                      <p>Most improved students would be shown here based on their progress between exams.</p>
                      <p className="text-sm mt-2">This requires comparing results across multiple examinations.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-center p-4 text-gray-500">
                      ...
                      <p>Students who might need additional academic support would be listed here.</p>
                      <p className="text-sm mt-2">Based on consistently low performance or declining scores.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* No data message */}
      {!loading && !error && (
        (activeTab === "overview" && (!classPerformance || !subjectPerformance)) ||
        (activeTab === "subjects" && (!selectedSubject || !subjectAnalysis)) ||
        (activeTab === "trends" && (!trendData || trendData.length === 0)) ||
        (activeTab === "students" && (!topStudents || topStudents.length === 0))
      ) && (
        <div className="bg-yellow-50 p-4 rounded-lg text-yellow-700">
          <div className="flex items-center">
            <AlertCircle className="h-5 w-5 mr-2" />
            <p>
              Select a class and exam to view analytics. Make sure exams have been conducted and grades have been entered.
            </p>
          </div>
        </div>
      )}
