...
const AddGradesModal = ({ isOpen, onClose, onSave }) => {
  ...
  useEffect(() => {
    ...
    const fetchInitialData = async () => {
      try {
        ...
        // Get sessions
        const sessionsResponse = await axios.get("http://localhost:5000/api/grading/sessions",{
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    ...
    const fetchClasses = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/api/grading/classes?academic_session_id=${selectedSession}`,{
            method: "GET",
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json",
    ...
    const fetchExams = async () => {
      try {
        setLoading(true);
        const response = await axios.get(
          `http://localhost:5000/api/examgrading?academic_session_id=${selectedSession}`,{
            method: "GET",
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    const fetchSubjects = async () => {
      try {
        setLoading(true);
        const response = await axios.get(
          `http://localhost:5000/api/grading/subjects/${selectedClass}`,{
            method: "GET",
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json",
    ...
    const fetchStudents = async () => {
      try {
        setLoading(true);
        const response = await axios.get(
          `http://localhost:5000/api/grading/students/${selectedClass}`,{
            method: "GET",
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json",
    ...
    const checkExamSchedule = async () => {
      try {
        ...
        const schedulesResponse = await axios.get(
          `http://localhost:5000/api/examgrading/${selectedExam}/schedules`,{
            method: "GET",
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json",
        ...
        if (schedule) {
          ...
          const gradesResponse = await axios.get(
            `http://localhost:5000/api/examgrading/schedules/${schedule.id}/results`,{
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Save grades
      await axios.post(`http://localhost:5000/api/examgrading/schedules/${scheduleId}/results`, {
