...
import { extractDate } from "../../util/helperFunctions";
  ...
  const EditTeacherModal = ({ teacher, isOpen, onClose, onSave }) => {
    ...
    useEffect(() => {
      const url = "/backend/api/subjects/subjects"
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between p-6 border-b">
                <h2 className="text-xl font-bold text-gray-900">Edit Teacher Information</h2>
                <button 
                  type="button" 
                  onClick={onClose} 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="flex flex-wrap gap-2 p-2 border rounded-lg">
                        {['Mathematics', 'Physics', 'Chemistry', 'Biology', 'English', 'Kiswahili'].map((subject) => (
...
export const DeleteConfirmationModal = ({ teacher, isOpen, onClose, onConfirm }) => (
    <div className={`fixed inset-0 z-50 ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}>
      <div className="fixed inset-0 bg-black opacity-50 transition-opacity" onClick={onClose} />
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg max-w-md w-full p-6">
          ...
          <h2 className="text-xl font-bold text-center mb-2">Delete Teacher Record</h2>
          <p className="text-gray-600 text-center mb-6">
            Are you sure you want to delete {teacher?.name}'s record? This action cannot be undone.
          </p>
