...
import { Home, Building, Users, Plus, Search, Edit, Trash, Eye, Filter, ChevronLeft, ChevronRight } from "lucide-react";
              ...
              {paginatedData.length === 0 && (
                <tr>
                  <td colSpan="7" className="px-6 py-4 text-center text-sm text-gray-500">
                    No dormitories found. Please adjust your search or add new dormitories.
                  </td>
                </tr>
              )}
            </tbody>
